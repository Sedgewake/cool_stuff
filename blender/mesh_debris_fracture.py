...
def bisect_mesh_with_fill(obj, point, normal):
...
def fracture_mesh(obj, num_pieces, random_seed=0):
    ...
    for i in range(num_cuts):
        ...
        new_pieces = bisect_mesh_with_fill(piece_to_split, point, normal)
...
class MESH_OT_debris_fracture(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        # Fracture the mesh
        pieces = fracture_mesh(obj, self.num_pieces, self.random_seed)
